...
data_root = 'Mmsegmentation_Datasets_alltraindata'
img_norm_cfg = dict(
    mean=[211.52,158.71,197.41], std=[39.53, 69.01, 43.30], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
...
log_level = 'INFO'
load_from = './checkpoints/semask_base_fpn_ade20k.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/semfpn_semask_swin_base_patch4_window12_512x512_80k_ade20k_alldata'
gpu_ids = range(0, 1)